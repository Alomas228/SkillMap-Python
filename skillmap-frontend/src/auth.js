// Управление JWT-токенами и перехват fetch для добавления Authorization header.
//
// Подменяет глобальный window.fetch так, чтобы каждый запрос к /api/...
// автоматически получал заголовок Authorization: Bearer <access>.
// При 401 пробует обновить access через /api/auth/refresh и повторить запрос один раз.
